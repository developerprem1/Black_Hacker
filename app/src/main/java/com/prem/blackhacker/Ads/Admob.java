...
public class Admob {
    ...
    public static void loadInterstitialsAds2 (Context context) {
        if (AdsUnit.isAds && AdsUnit.isInterstitialAds) {
            ...
            InterstitialAd.load(context, AdsUnit.INTERSTITIAL2, adRequest,
                    new InterstitialAdLoadCallback() {
                        @Override
                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
    ...
    public  void showInterstitialsAds2(Activity activity, boolean isReload){
